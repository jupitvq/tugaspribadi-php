  ...
  <div class="content-wrapper">
    ...
    <div class="card-body">
      <div class="alert alert-success alert-dismissible">
          ...
          <h5><i class="icon fas fa-check"></i> Hello, <?php echo $session = session()->get('name'); ?>.</h5>
          You may now check <a href="/employees">employees menu</a> to begin!
      </div>
    </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            ...
            <div class="card card-danger">
              ...
              <div class="card-body">
                <h6 class="card-title">Feeling signing out?</h6>

                <p class="card-text">If you done with your work, click on <b>Logout</b> below!</p>
